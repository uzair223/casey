  ...
  return (
    <Interactive.Div
      ...
      style={{
        ...
        height: size,
        borderRadius: "50%",
        background: `radial-gradient(circle, ${color} 0%, rgba(20, 20, 20, 0) 70%)`,
